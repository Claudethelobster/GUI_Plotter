...
from core.plot_worker import PlotWorkerThread, BackgroundWorker
...
# Optional: If you want to keep the OPENGL_AVAILABLE flag working smoothly in main:
try:
    import pyqtgraph.opengl as gl
...
class BadgerLoopQtGraph(QMainWindow):
    ...
    def _write_csv_mirror_from_existing(self, src, dest):
        FileEditor.write_csv_mirror_from_existing(src, dest)
        
    def _write_csv_mirror(self, filepath):
        FileEditor.write_csv_mirror(self.dataset, filepath)
    ...
    def _append_column_to_file(self, target_file, new_name, calculated_blocks):
        ...
        FileEditor.append_column_to_file(self.file_type, self.dataset, target_file, new_name, calculated_blocks, opts)
